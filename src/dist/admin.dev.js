...
$(document).ready(function () {
  ...
  fetchSubmittedVendors(); // Function to fetch submitted vendors
  ...
  function displaySubmittedVendors(vendors) {} // Code to display vendors (similar to your existing logic)
